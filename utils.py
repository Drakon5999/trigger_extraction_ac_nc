...
def load_data(dataset, folder="./data"):
    """
    ...
    """
    if dataset == 'MNIST':
        train_data = datasets.MNIST(folder, train=True, download=True, transform=transforms.ToTensor())
        test_data = datasets.MNIST(folder, train=False, download=True, transform=transforms.ToTensor())
        num_classes = 10
        ...
        train_data = datasets.CIFAR10(folder, train=True, download=True, transform=train_transform)
        test_data = datasets.CIFAR10(folder, train=False, download=True, transform=test_transform)
        num_classes = 10
    elif dataset == 'CIFAR-100':
        train_transform = transforms.Compose([transforms.RandomHorizontalFlip(), transforms.ToTensor()])
        test_transform = transforms.ToTensor()

        train_data = datasets.CIFAR100(folder, train=True, download=True, transform=train_transform)
        test_data = datasets.CIFAR100(folder, train=False, download=True, transform=test_transform)
        num_classes = 100
    elif dataset == 'GTSRB':
        train_transform = transforms.Compose([transforms.ToTensor()])
        test_transform = transforms.ToTensor()

        train_data = datasets.ImageFolder(folder + '/gtsrb_preprocessed/train', transform=train_transform)
        test_data = datasets.ImageFolder(folder + '/gtsrb_preprocessed/test', transform=test_transform)
        num_classes = 43
